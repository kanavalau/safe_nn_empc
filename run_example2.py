...
import numpy as np
from dyn_systems import dyn_example2
...
system = dyn_example2(nn_model=constr_policy_loc)

# Data generation
# Running system.generate_data with the different inputs is going to replace 
# the data files present in example2/
...
# the model parameters stored in example2/unconstrained_model
# system.epochs = 50000
...
# Running the training is going to save/replace
# the model parameters stored in example2/primal_dual_model
# system.epochs = 50000
# system.lr_primal = 10**(-4)
# system.lr_dual = 10**(-4)
...
# and saves the plots in example2/
